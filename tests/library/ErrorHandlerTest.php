...
class ErrorHandlerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testErrorCodeZeroPDOExceptionWithVerboseErrorsTriggersUnknownTemplate() {
        ...
        $this->eh->handleError($e);
        $this->assertEquals(500, $this->eh->getResponse()->getResponseCode(), "Correct response code");
        $this->assertTrue(strpos($this->eh->getResponse()->getBody(), "An unknown exception code was thrown") !== false, "Body has correct contents");
    }
    ...
    public function testErrorCodeZeroSmartyCompilerException() {
        ...
        $this->eh->handleError($e);
        $this->assertEquals(500, $this->eh->getResponse()->getResponseCode(), "Correct response code");
        $this->assertTrue(strpos($this->eh->getResponse()->getBody(), "An error occured whilst compiling the smarty template") !== false, "Body has correct contents");
    }
    ...
    public function testUnhandledExceptionType() {
        ...
        $this->eh->handleError($e);
        $this->assertEquals(500, $this->eh->getResponse()->getResponseCode(), "Correct response code");
        $this->assertTrue(strpos($this->eh->getResponse()->getBody(), "An unknown type of exception was thrown") !== false, "Body has correct contents");
    }
